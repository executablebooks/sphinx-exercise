...
\sphinxAtStartPar
This is a link to {\hyperref[\detokenize{exercise:exercise-1}]{\sphinxcrossref{\(n!\) factorial}}}
...
\sphinxAtStartPar
This is a link to {\hyperref[\detokenize{solution:solution-1}]{\sphinxcrossref{\DUrole{std,std-ref}{Solution to } Exercise 1}}}
